...
match_aggregate <- readRDS("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/full_aggregate_V4_for_prediction_with_NN_20240314_to_20240516.RDS")
...
for(temp_date_i in 1:length(temp_date_list)){
  ...
  if(temp_date %in% match_aggregate$EOD_option_quote_date){
    ...
    temp_output <- temp_pred[,c(colnames(temp_pred)[grepl("prediction_",colnames(temp_pred))],
                                colnames(temp_pred)[grepl("ahead",colnames(temp_pred))],
                                "avgOpenClose","EOD_option_underlying_ticker","EOD_option_quote_date",colnames(temp_mbData))]
