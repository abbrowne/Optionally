...
for(temp_date_i in 1:length(all_dates)){
    ...
    for(temp_counter_i in 1:25){
        if((temp_date_i+temp_counter_i) < length(all_dates)){
            ...
            temp_result[,paste0("time",temp_counter_i,"_increase6")] = as.numeric(comp_aggregate[rownames(temp_aggregate),"option_underlying_price"] >= 1.06*temp_aggregate$option_underlying_price)
            ...
            temp_result[,paste0("time",temp_counter_i,"_increase6")] = NA
    ...
    if(temp_date_i %% 100 == 0){
      saveRDS(full_outcomes,file=paste0("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/full_outcomes_20210514_to_20240404_V3_part",file_counter_i,".RDS"))
      full_outcomes <- NULL
...
all_files <- all_files[grepl("full_outcomes_20210514_to_20240404_V3_part",all_files)]
full_outcomes <- NULL
...
saveRDS(full_outcomes,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/full_outcomesV3_20210514_to_20240404.RDS")
...
rate_df <- as.data.frame(list(date=all_dates,EOD=all_rates$DFF,EMA5=all_EMA5,EMA10=all_EMA10,EMA20=all_EMA20,EMA50=all_EMA50))
saveRDS(rate_df,file="E:/Market_Data/FedRateDF_current_working.RDS")
...
full_results <- full_results[full_results$Date <= max(merge_aggregate$EOD_option_quote_date),]
...
match_aggregate <- match_aggregate[rowSums(is.na(match_aggregate)) == 0,]
...
last_training_date <- max(match_aggregate$EOD_option_quote_date)

####

test_group <- match_aggregate$outcomes_5d02pctEMA5above
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V4_5d02pctAbove_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_10d04pctEMA5above
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V4_10d04pctAbove_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_15d06pctEMA5above
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V4_15d06pctAbove_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_20d08pctEMA5above
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V4_20d08pctAbove_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_25d10pctEMA5above
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V4_25d10pctAbove_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_50d20pctEMA5above
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V4_50d20pctAbove_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_5d0pctEMA5below
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V4_5d0pctBelow_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_10d0pctEMA5below
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V4_10d0pctBelow_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_15d0pctEMA5below
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V4_15d0pctBelow_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_20d0pctEMA5below
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V4_20d0pctBelow_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_25d0pctEMA5below
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V4_25d0pctBelow_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_50d0pctEMA5below
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V4_50d0pctBelow_for_NN.tsv",sep="\t")

for(temp_i in 1:50){
  temp_colname <- paste0("relative_avgOpenClose_ahead",temp_i)
  temp_base_dir <- "E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/"
  temp_filename <- paste0(temp_base_dir,"test_output_V4_avgOpenClose",temp_i,"dAhead_for_NN.tsv")
  write.table(match_aggregate[,temp_colname],file=temp_filename,sep="\t")
}
...
write.table(t(test_input),file=paste0("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/test_input_V4_for_prediction_with_NN_20240314_to_",
                                      paste0(unlist(str_split(last_training_date,"-")),collapse = ""),".tsv"),sep="\t")
saveRDS(match_aggregate,paste0("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/full_aggregate_V4_for_prediction_with_NN_20240314_to_",
                               paste0(unlist(str_split(last_training_date,"-")),collapse = ""),".RDS"))


#######################################################################Remove below once above working
...
###Aggregate together daily, EMA8, and EMA20 data for option aggregates including underlying price
option_aggregate <- readRDS("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/full_option_aggregate_2024-01-22_to_2024-04-10.RDS")
option_aggregate <- option_aggregate[option_aggregate$option_underlying_ticker %in% SP500_tickers,]
option_aggregate <- option_aggregate[option_aggregate$option_quote_date >= "2024-01-22" & option_aggregate$option_quote_date <= "2024-04-10",]
temp_aggregate <- readRDS("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/full_option_aggregate_2023-09-04_to_2024-01-19.RDS")
temp_aggregate <- temp_aggregate[temp_aggregate$option_underlying_ticker %in% SP500_tickers,]
temp_aggregate <- temp_aggregate[temp_aggregate$option_quote_date >= "2023-09-04" & temp_aggregate$option_quote_date <= "2024-01-19",]
option_aggregate <- as.data.frame(rbind(temp_aggregate,option_aggregate))
...
EMA5_aggregate <- readRDS("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/EMA5_aggregate_2024-01-22_to_2024-04-10.RDS")
EMA5_aggregate <- EMA5_aggregate[EMA5_aggregate$option_underlying_ticker %in% SP500_tickers,]
EMA5_aggregate <- EMA5_aggregate[EMA5_aggregate$option_quote_date >= "2024-01-22" & EMA5_aggregate$option_quote_date <= "2024-04-10",]
temp_aggregate <- readRDS("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/EMA5_aggregate_2023-09-04_to_2024-01-19.RDS")
temp_aggregate <- temp_aggregate[temp_aggregate$option_underlying_ticker %in% SP500_tickers,]
temp_aggregate <- temp_aggregate[temp_aggregate$option_quote_date >= "2023-09-04" & temp_aggregate$option_quote_date <= "2024-01-19",]
EMA5_aggregate <- as.data.frame(rbind(temp_aggregate,EMA5_aggregate))
...
EMA10_aggregate <- readRDS("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/EMA10_aggregate_2024-01-22_to_2024-04-10.RDS")
EMA10_aggregate <- EMA10_aggregate[EMA10_aggregate$option_underlying_ticker %in% SP500_tickers,]
EMA10_aggregate <- EMA10_aggregate[EMA10_aggregate$option_quote_date >= "2024-01-22" & EMA10_aggregate$option_quote_date <= "2024-04-10",]
temp_aggregate <- readRDS("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/EMA10_aggregate_2023-09-04_to_2024-01-19.RDS")
temp_aggregate <- temp_aggregate[temp_aggregate$option_underlying_ticker %in% SP500_tickers,]
temp_aggregate <- temp_aggregate[temp_aggregate$option_quote_date >= "2023-09-04" & temp_aggregate$option_quote_date <= "2024-01-19",]
EMA10_aggregate <- as.data.frame(rbind(temp_aggregate,EMA10_aggregate))
...
EMA20_aggregate <- readRDS("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/EMA20_aggregate_2024-01-22_to_2024-04-10.RDS")
EMA20_aggregate <- EMA20_aggregate[EMA20_aggregate$option_underlying_ticker %in% SP500_tickers,]
EMA20_aggregate <- EMA20_aggregate[EMA20_aggregate$option_quote_date >= "2024-01-22" & EMA20_aggregate$option_quote_date <= "2024-04-10",]
temp_aggregate <- readRDS("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/EMA20_aggregate_2023-09-04_to_2024-01-19.RDS")
temp_aggregate <- temp_aggregate[temp_aggregate$option_underlying_ticker %in% SP500_tickers,]
temp_aggregate <- temp_aggregate[temp_aggregate$option_quote_date >= "2023-09-04" & temp_aggregate$option_quote_date <= "2024-01-19",]
EMA20_aggregate <- as.data.frame(rbind(temp_aggregate,EMA20_aggregate))
...
EMA50_aggregate <- readRDS("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/EMA50_aggregate_2024-01-22_to_2024-04-10.RDS")
EMA50_aggregate <- EMA50_aggregate[EMA50_aggregate$option_underlying_ticker %in% SP500_tickers,]
EMA50_aggregate <- EMA50_aggregate[EMA50_aggregate$option_quote_date >= "2024-01-22" & EMA50_aggregate$option_quote_date <= "2024-04-10",]
temp_aggregate <- readRDS("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/EMA50_aggregate_2023-09-04_to_2024-01-19.RDS")
temp_aggregate <- temp_aggregate[temp_aggregate$option_underlying_ticker %in% SP500_tickers,]
temp_aggregate <- temp_aggregate[temp_aggregate$option_quote_date >= "2023-09-04" & temp_aggregate$option_quote_date <= "2024-01-19",]
EMA50_aggregate <- as.data.frame(rbind(temp_aggregate,EMA50_aggregate))
...
###Remove dates surrounding stock splits
SP500_splits <- readRDS("E:/Market_Data/SP500_splits_20240410.RDS")
...
write.table(t(test_input),file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/test_input_for_prediction_with_NN_20240314_to_20240410.tsv",sep="\t")
saveRDS(merge_aggregate,"E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/full_aggregate_for_prediction_with_NN_20240314_to_20240410.RDS")
...
#input_dataset <- read.table("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/test_input_for_prediction_with_NN_20240314_to_20240410.tsv",sep="\t")
merge_aggregate <- readRDS("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/full_aggregate_for_prediction_with_NN_20240314_to_20240411.RDS")

temp_predictions <- read.table("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/realtime_testing_predictions_merged9up10d_output.tsv",sep="\t",header=TRUE)

rownames(temp_predictions) <- rownames(merge_aggregate)
temp_predictions$Ticker <- merge_aggregate$EOD_option_underlying_ticker
temp_predictions$Date <- merge_aggregate$EOD_option_quote_date
temp_predictions$starting_price <- merge_aggregate$EOD_option_underlying_price

positive_predictions <- temp_predictions[temp_predictions$Predicted == "True",]
pricing_results <- NULL
for(temp_row_i in 1:nrow(positive_predictions)){
  temp_ticker <- positive_predictions$Ticker[temp_row_i]
  start_date <- positive_predictions$Date[temp_row_i]+1
  end_date <- start_date + 20
  temp_results <- getSymbols(temp_ticker, src = "yahoo", from = start_date, to = end_date, auto.assign = FALSE)
  colnames(temp_results) <- c("Open","High","Low","Close","Volume","Adjusted")
  temp_open <- as.vector(temp_results$Open)
  if(length(temp_open) < 11){
    temp_open <- c(temp_open,rep(NA,11-length(temp_open)))
  }else{
    temp_open <- temp_open[1:11]
  }
  temp_close <- as.vector(temp_results$Close)
  if(length(temp_close) < 11){
    temp_close <- c(temp_close,rep(NA,11-length(temp_close)))
  }else{
    temp_close <- temp_close[1:11]
  }
  temp_high <- as.vector(temp_results$High)
  if(length(temp_high) < 11){
    temp_high <- c(temp_high,rep(NA,11-length(temp_high)))
  }else{
    temp_high <- temp_high[1:11]
  }
  temp_low <- as.vector(temp_results$Low)
  if(length(temp_low) < 11){
    temp_low <- c(temp_low,rep(NA,11-length(temp_low)))
  }else{
    temp_low <- temp_low[1:11]
  }
  temp_prices <- c(temp_open,temp_close,temp_high,temp_low)
  temp_max <- max(temp_prices[c(10,21,32,43)],na.rm = TRUE)
  temp_prices <- as.data.frame(t(c(temp_max,temp_prices)))
  colnames(temp_prices) <- c("Max_price",paste0(rep("Day",44),rep(seq(1:11),4),c(rep("_Open",11),rep("_Close",11),rep("_High",11),rep("_Low",11))))
  if(is.null(pricing_results)){
    pricing_results <- temp_prices
  }else{
    pricing_results <- rbind(pricing_results,temp_prices)
  }
}
rownames(pricing_results) <- rownames(positive_predictions)
positive_predictions <- cbind(positive_predictions, pricing_results)

target_return <- 1.02
positive_predictions$target_price <- positive_predictions$starting_price * target_return

positive_predictions <- positive_predictions[rowSums(is.na(positive_predictions)) == 0,]

test_dates <- unique(positive_predictions$Date)
test_dates <- test_dates[order(test_dates)]
for(temp_i in 1:length(test_dates)){
    test <- positive_predictions[positive_predictions$Date == test_dates[temp_i],]
    print(test_dates[temp_i])
    print(paste0("Total tickers: ",sum(positive_predictions$Date == test_dates[temp_i])))
    print(paste0("Accuracy: ",100*round((sum(test$Max_price > test$target_price) / nrow(test)),2),"%"))
    print(paste0("Mean return: ",100*round(mean(test$Max_price / test$starting_price)-1,2),"%"))
}

#####
temp_predictions <- read.table("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/realtime_testing_predictions_merged5up10d_output.tsv",sep="\t",header=TRUE)
merge_aggregate <- readRDS("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/full_aggregate_for_prediction_with_NN_20240314_to_20240410.RDS")
...
yesterday_date <- format(yesterday_date, "%Y-%m-%d")

daily_predictions <- positive_predictions[positive_predictions$Date ==  yesterday_date,]
tickers_to_check <- daily_predictions$Ticker
...
sentiment_list <- NULL
for(temp_i in 1:length(tickers_to_check)){
  temp_sentiment <- getMBSentiment(tickers_to_check[temp_i])
  if(is.null(sentiment_list)){
    sentiment_list <- temp_sentiment
  }else{
    sentiment_list <- c(sentiment_list,temp_sentiment)
  }
}

daily_predictions$Day1_sentiment <- sentiment_list

saveRDS(daily_predictions,paste0("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/Predictions_for_5up10d_with_sentiment_for_",yesterday_date,".RDS"))


###Check day of week accuracy on test data!!!
temp_predictions <- read.table("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/testing_predictions_merged9up10d_output.tsv",sep="\t",header=TRUE)
merge_aggregate <- read.table("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/primary_testing_input.tsv",sep="\t",header=TRUE)
temp_dates <- lapply(colnames(merge_aggregate), function(x) { as.Date(str_split(x, "_")[[1]][2], format = "%Y%m%d") })
temp_predictions$Date <- as.Date(unlist(temp_dates))
temp_predictions$Weekday <- weekdays(temp_predictions$Date)
temp_predictions$TP <- (temp_predictions$Actual == 1 & temp_predictions$Predicted == "True")
temp_predictions$FP <- (temp_predictions$Actual == 0 & temp_predictions$Predicted == "True")

###From quick check on testing dataset, Monday is the worst day to run predictions

###Redo modeling with outcome measuring difference at 10th day

```

```{r get all pricing data for SP500 stocks for model date range}
...
saveRDS(full_results,file="E:/Market_Data/SP500_3yr_price_history.RDS")


```

```{r recalculate outcomes with EMAs from more complete pricing data from yahoo}

full_results <- readRDS("E:/Market_Data/SP500_3yr_price_history.RDS")
...
saveRDS(full_results,file="E:/Market_Data/SP500_3yr_price_history_with_EMAs.RDS")

full_results <- readRDS("E:/Market_Data/SP500_3yr_price_history_with_EMAs.RDS")
...
for(temp_day_i in 1:length(days_to_test)){
  ...
  for(temp_pct_i in 1:length(pcts_to_test)){
    ...
    if(temp_day > 5){
      temp_colname <- paste0("outcomes_",temp_day,"d",temp_pct,"pctEMA10above")
      temp_EMACol <- paste0("EMA10ahead",temp_day)
      full_results[,temp_colname] <- ((full_results[,temp_EMACol] / full_results[,"avgOpenClose"]) > temp_pctVal)
    }
  }
  ...
  if(temp_day > 5){
    temp_colname <- paste0("outcomes_",temp_day,"d","0pctEMA10below")
    temp_EMACol <- paste0("EMA10ahead",temp_day)
    full_results[,temp_colname] <- (full_results[,"avgOpenClose"] > full_results[,temp_EMACol])
  }
}
...
###Parse input to match new outcomes
merge_aggregate <- readRDS("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/prefilter_merged_aggregate_for_NN_20210514_to_20240404.RDS")
#merge_aggregate <- merge_aggregate[,!grepl("outcomes_",colnames(merge_aggregate))]
...
test_group <- match_aggregate$outcomes_5d02pctEMA5above
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_5d02pctAbove_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_10d04pctEMA5above
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_10d04pctAbove_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_15d06pctEMA5above
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_15d06pctAbove_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_20d08pctEMA5above
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_20d08pctAbove_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_25d10pctEMA5above
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_25d10pctAbove_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_50d20pctEMA5above
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_50d20pctAbove_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_5d0pctEMA5below
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_5d0pctBelow_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_10d0pctEMA5below
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_10d0pctBelow_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_15d0pctEMA5below
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_15d0pctBelow_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_20d0pctEMA5below
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_20d0pctBelow_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_25d0pctEMA5below
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_25d0pctBelow_for_NN.tsv",sep="\t")

test_group <- match_aggregate$outcomes_50d0pctEMA5below
test_output = as.numeric(test_group)
write.table(test_output,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_50d0pctBelow_for_NN.tsv",sep="\t")

write.table(match_aggregate$relative_avgOpenClose_ahead5,
            file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_avgOpenClose5dAhead_for_NN.tsv",sep="\t")
write.table(match_aggregate$relative_avgOpenClose_ahead10,
            file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_avgOpenClose10dAhead_for_NN.tsv",sep="\t")
write.table(match_aggregate$relative_avgOpenClose_ahead15,
            file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_avgOpenClose15dAhead_for_NN.tsv",sep="\t")
write.table(match_aggregate$relative_avgOpenClose_ahead20,
            file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_avgOpenClose20dAhead_for_NN.tsv",sep="\t")
write.table(match_aggregate$relative_avgOpenClose_ahead25,
            file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_avgOpenClose25dAhead_for_NN.tsv",sep="\t")
write.table(match_aggregate$relative_avgOpenClose_ahead50,
            file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_output_V3_avgOpenClose50dAhead_for_NN.tsv",sep="\t")

###

saveRDS(match_aggregate,file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/matched_aggregate_V3_for_NN.RDS")
write.table(t(test_input),file="E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/test_inputV3_for_NN.tsv",sep="\t")


```

```{r processing of daily predictions and merging with extra data}
...
match_aggregate <- readRDS("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/full_aggregate_V4_for_prediction_with_NN_20240314_to_20240930.RDS")

base_dir <- "E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/Predictions/"
prediction_files <- list.files(base_dir)
prediction_files <- prediction_files[grepl("_V4_",prediction_files) & grepl("realtime_",prediction_files)]
prediction_names <- unlist(lapply(prediction_files,function(x){paste0("prediction_",str_split(x,"_")[[1]][8])}))
alt_names <- unlist(lapply(prediction_names,function(x){str_replace(x,"prediction_","predictionProbability_")}))

for(temp_i in 1:length(prediction_files)){
  prediction_dataset <- read.csv(paste0(base_dir,prediction_files[temp_i]),sep="\t")
  rownames(prediction_dataset) <- rownames(match_aggregate)
  match_aggregate[,prediction_names[temp_i]] <- prediction_dataset$Predicted
  match_aggregate[,alt_names[temp_i]] <- prediction_dataset$Probability
}
...
all_sectors$Symbol[all_sectors$Symbol == "BF.B"] = "BFB"
rownames(all_sectors) <- all_sectors$Symbol
all_sectors["BRKB","Industry"] <- "Diversified Commercial Services"
all_sectors["ANSS","Industry"] <- "Computer Software: Prepackaged Software"
all_sectors["WRK","Industry"] <- "Containers/Packaging"
all_sectors["GEV","Industry"] <- "Electric Utilities: Central"
all_sectors["BFB","Industry"] <- "Beverages (Production/Distribution)"

match_aggregate$EOD_underlying_stock_sector <- all_sectors[match_aggregate$EOD_option_underlying_ticker,"Sector"]
match_aggregate$EOD_underlying_stock_industry <- all_sectors[match_aggregate$EOD_option_underlying_ticker,"Industry"]
colnames(match_aggregate)[colnames(match_aggregate) == "Open"] <- "EOD_underlying_open_price"
colnames(match_aggregate)[colnames(match_aggregate) == "Close"] <- "EOD_underlying_close_price"
colnames(match_aggregate)[colnames(match_aggregate) == "High"] <- "EOD_underlying_high_price"
colnames(match_aggregate)[colnames(match_aggregate) == "Low"] <- "EOD_underlying_low_price"
colnames(match_aggregate)[colnames(match_aggregate) == "Volume"] <- "EOD_underlying_total_volume"
colnames(match_aggregate)[colnames(match_aggregate) == "Adjusted"] <- "EOD_underlying_adjusted_close"

temp_date_list <- seq.Date(min(match_aggregate$EOD_option_quote_date),max(match_aggregate$EOD_option_quote_date),by=1)
temp_date_list <- temp_date_list[temp_date_list >= "2024-04-15"]
print(max(temp_date_list))
for(temp_date_i in 1:length(temp_date_list)){
  temp_date <- temp_date_list[temp_date_i]
  if(temp_date %in% match_aggregate$EOD_option_quote_date){
    
    date_to_check <- temp_date
    ##Select marketbeat date that is the next day after the date to check from the model prediction due to the timing of the data
    #temp_mbData <- readRDS(paste0("E:/Market_Data/MarketBeat/MarketBeat_SP500_data_",as.Date(date_to_check,format = "%Y-%m-%d") + 1,".RDS"))
    #temp_mbData <- temp_mbData[,c("analyst_rating","updownside","analyst_score","price_target",
    #                              "short_interest","shares_sold_short","dividend_strength","sustainability_score",
    #                              "news_sentiment","insider_trading","projected_earnings_growth")]
    
    temp_pred <- match_aggregate[match_aggregate$EOD_option_quote_date == date_to_check,]
    #temp_pred <- cbind(temp_pred,temp_mbData[temp_pred$EOD_option_underlying_ticker,])
    temp_output <- temp_pred[,c("EOD_option_underlying_ticker","EOD_option_quote_date","avgOpenClose",
                                colnames(match_aggregate)[grepl("EOD_underlying_",colnames(match_aggregate))],#colnames(temp_mbData),
                                colnames(temp_pred)[grepl("prediction",colnames(temp_pred))],
                                colnames(temp_pred)[grepl("ahead",colnames(temp_pred))])]
    temp_output[,grepl("prediction_change",colnames(temp_output))] <- round(temp_output[,grepl("prediction_change",colnames(temp_output))],3)
    temp_columns <- paste0("relative_avgOpenClose_ahead",seq(1,25))
    temp_output$relativeMax5d <- apply(temp_output[,temp_columns[1:5]], 1, max)
    temp_output$relativeMax10d <- apply(temp_output[,temp_columns[1:10]], 1, max)
    temp_output$relativeMax15d <- apply(temp_output[,temp_columns[1:15]], 1, max)
    temp_output$relativeMax20d <- apply(temp_output[,temp_columns[1:20]], 1, max)
    temp_output$relativeMax25d <- apply(temp_output[,temp_columns[1:25]], 1, max)
    temp_columns <- paste0("prediction_change",seq(1,25),"d")
    temp_output$predMaxChange5d <- apply(temp_output[,temp_columns[1:5]], 1, max)
    temp_output$predMaxChange10d <- apply(temp_output[,temp_columns[1:10]], 1, max)
    temp_output$predMaxChange15d <- apply(temp_output[,temp_columns[1:15]], 1, max)
    temp_output$predMaxChange20d <- apply(temp_output[,temp_columns[1:20]], 1, max)
    temp_output$predMaxChange25d <- apply(temp_output[,temp_columns[1:25]], 1, max)
    
    temp_pred1 <- as.numeric(temp_output$predMaxChange5d >= 1.02)
    temp_pred2 <- as.numeric(temp_output$predictionProbability_output2up5d > 0.9)
    temp_pred3 <- -1 * as.numeric(temp_output$predictionProbability_negoutput5d > 0.9)
    temp_output$predScore5d <- -1 + temp_pred1 + temp_pred2# + temp_pred3
    temp_output$relativeTarget5d <- 0
    temp_output$relativeTarget5d[temp_output$relativeMax5d >= 1.01] <- 1
    temp_output$relativeTarget5d[temp_output$relativeMax5d >= 1.02] <- 2
    temp_output$relativeTarget5d[temp_output$relativeMax5d >= 1.03] <- 3
    temp_output$relativeTarget5d[temp_output$relativeMax5d >= 1.04] <- 4
    temp_output$predTarget5d <- 0
    temp_output$predTarget5d[temp_output$predMaxChange5d >= 1.01] <- 1
    temp_output$predTarget5d[temp_output$predMaxChange5d >= 1.02] <- 2
    temp_output$predTarget5d[temp_output$predMaxChange5d >= 1.03] <- 3
    temp_output$predTarget5d[temp_output$predMaxChange5d >= 1.04] <- 4
    
    temp_pred1 <- as.numeric(temp_output$predMaxChange10d >= 1.04)
    temp_pred2 <- as.numeric(temp_output$predictionProbability_output4up10d > 0.9)
    temp_pred3 <- -1 * as.numeric(temp_output$predictionProbability_negoutput10d > 0.9)
    temp_output$predScore10d <- -1 + temp_pred1 + temp_pred2# + temp_pred3
    temp_output$relativeTarget10d <- 0
    temp_output$relativeTarget10d[temp_output$relativeMax10d >= 1.02] <- 1
    temp_output$relativeTarget10d[temp_output$relativeMax10d >= 1.04] <- 2
    temp_output$relativeTarget10d[temp_output$relativeMax10d >= 1.06] <- 3
    temp_output$relativeTarget10d[temp_output$relativeMax10d >= 1.08] <- 4
    temp_output$predTarget10d <- 0
    temp_output$predTarget10d[temp_output$predMaxChange10d >= 1.02] <- 1
    temp_output$predTarget10d[temp_output$predMaxChange10d >= 1.04] <- 2
    temp_output$predTarget10d[temp_output$predMaxChange10d >= 1.06] <- 3
    temp_output$predTarget10d[temp_output$predMaxChange10d >= 1.08] <- 4
    
    temp_pred1 <- as.numeric(temp_output$predMaxChange15d >= 1.06)
    temp_pred2 <- as.numeric(temp_output$predictionProbability_output6up15d > 0.9)
    temp_pred3 <- -1 * as.numeric(temp_output$predictionProbability_negoutput15d > 0.9)
    temp_output$predScore15d <- -1 + temp_pred1 + temp_pred2# + temp_pred3
    temp_output$relativeTarget15d <- 0
    temp_output$relativeTarget15d[temp_output$relativeMax15d >= 1.03] <- 1
    temp_output$relativeTarget15d[temp_output$relativeMax15d >= 1.06] <- 2
    temp_output$relativeTarget15d[temp_output$relativeMax15d >= 1.09] <- 3
    temp_output$relativeTarget15d[temp_output$relativeMax15d >= 1.12] <- 4
    temp_output$predTarget15d <- 0
    temp_output$predTarget15d[temp_output$predMaxChange15d >= 1.03] <- 1
    temp_output$predTarget15d[temp_output$predMaxChange15d >= 1.06] <- 2
    temp_output$predTarget15d[temp_output$predMaxChange15d >= 1.09] <- 3
    temp_output$predTarget15d[temp_output$predMaxChange15d >= 1.12] <- 4
    
    temp_pred1 <- as.numeric(temp_output$predMaxChange20d >= 1.08)
    temp_pred2 <- as.numeric(temp_output$predictionProbability_output8up20d > 0.9)
    temp_pred3 <- -1 * as.numeric(temp_output$predictionProbability_negoutput20d > 0.9)
    temp_output$predScore20d <- -1 + temp_pred1 + temp_pred2# + temp_pred3
    temp_output$relativeTarget20d <- 0
    temp_output$relativeTarget20d[temp_output$relativeMax20d >= 1.04] <- 1
    temp_output$relativeTarget20d[temp_output$relativeMax20d >= 1.08] <- 2
    temp_output$relativeTarget20d[temp_output$relativeMax20d >= 1.12] <- 3
    temp_output$relativeTarget20d[temp_output$relativeMax20d >= 1.16] <- 4
    temp_output$predTarget20d <- 0
    temp_output$predTarget20d[temp_output$predMaxChange20d >= 1.04] <- 1
    temp_output$predTarget20d[temp_output$predMaxChange20d >= 1.08] <- 2
    temp_output$predTarget20d[temp_output$predMaxChange20d >= 1.12] <- 3
    temp_output$predTarget20d[temp_output$predMaxChange20d >= 1.16] <- 4
    
    temp_pred1 <- as.numeric(temp_output$predMaxChange25d >= 1.10)
    temp_pred2 <- as.numeric(temp_output$predictionProbability_output10up25d > 0.9)
    temp_pred3 <- -1 * as.numeric(temp_output$predictionProbability_negoutput25d > 0.9)
    temp_output$predScore25d <- -1 + temp_pred1 + temp_pred2# + temp_pred3
    temp_output$relativeTarget25d <- 0
    temp_output$relativeTarget25d[temp_output$relativeMax25d >= 1.05] <- 1
    temp_output$relativeTarget25d[temp_output$relativeMax25d >= 1.10] <- 2
    temp_output$relativeTarget25d[temp_output$relativeMax25d >= 1.15] <- 3
    temp_output$relativeTarget25d[temp_output$relativeMax25d >= 1.20] <- 4
    temp_output$predTarget25d <- 0
    temp_output$predTarget25d[temp_output$predMaxChange25d >= 1.05] <- 1
    temp_output$predTarget25d[temp_output$predMaxChange25d >= 1.10] <- 2
    temp_output$predTarget25d[temp_output$predMaxChange25d >= 1.15] <- 3
    temp_output$predTarget25d[temp_output$predMaxChange25d >= 1.20] <- 4
    
    temp_output <- temp_output[,!grepl("EMA5ahead",colnames(temp_output)) & 
                               !grepl("prediction_negoutput",colnames(temp_output)) & 
                               !grepl("prediction_output",colnames(temp_output)) & 
                               (!grepl("avgOpenClose_ahead",colnames(temp_output)) | grepl("relative_",colnames(temp_output)))]

    write.table(temp_output,file=paste0("C:/Users/Andy/Downloads/Investing files/Investing_Project_Rstudio/test_prediction_output_",temp_date,".tsv"),sep="\t")
