...
for(temp_ticker_i in 1:length(SP500_tickers)){
  ...
  if(!(temp_ticker %in% stocks_to_drop)){
    splits <- getSplits(temp_ticker,from="2021-05-10",to="2024-04-11")
...
saveRDS(all_splits,"E:/Market_Data/SP500_splits_20240411.RDS")
...
match_aggregate <- readRDS("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/full_aggregate_V3_for_prediction_with_NN_20240314_to_20240506.RDS")

prediction_dataset <- read.csv("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/Predictions/realtime_data_predictions_working_model_V3_primary2up5d_output.tsv",sep="\t")
rownames(prediction_dataset) <- rownames(match_aggregate)
match_aggregate$prediction_2up5d <- prediction_dataset$Predicted
prediction_dataset <- read.csv("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/Predictions/realtime_data_predictions_working_model_V3_primary4up10d_output.tsv",sep="\t")
rownames(prediction_dataset) <- rownames(match_aggregate)
match_aggregate$prediction_4up10d <- prediction_dataset$Predicted
prediction_dataset <- read.csv("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/Predictions/realtime_data_predictions_working_model_V3_primary6up15d_output.tsv",sep="\t")
rownames(prediction_dataset) <- rownames(match_aggregate)
match_aggregate$prediction_6up15d <- prediction_dataset$Predicted
prediction_dataset <- read.csv("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/Predictions/realtime_data_predictions_working_model_V3_primary8up20d_output.tsv",sep="\t")
rownames(prediction_dataset) <- rownames(match_aggregate)
match_aggregate$prediction_8up20d <- prediction_dataset$Predicted
prediction_dataset <- read.csv("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/Predictions/realtime_data_predictions_working_model_V3_primary10up25d_output.tsv",sep="\t")
rownames(prediction_dataset) <- rownames(match_aggregate)
match_aggregate$prediction_10up25d <- prediction_dataset$Predicted
prediction_dataset <- read.csv("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/Predictions/realtime_data_predictions_working_model_V3_primary20up50d_output.tsv",sep="\t")
rownames(prediction_dataset) <- rownames(match_aggregate)
match_aggregate$prediction_20up50d <- prediction_dataset$Predicted
prediction_dataset <- read.csv("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/Predictions/realtime_data_predictions_working_model_V3_primary0down5d_output.tsv",sep="\t")
rownames(prediction_dataset) <- rownames(match_aggregate)
match_aggregate$prediction_0down5d <- prediction_dataset$Predicted
prediction_dataset <- read.csv("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/Predictions/realtime_data_predictions_working_model_V3_primary0down10d_output.tsv",sep="\t")
rownames(prediction_dataset) <- rownames(match_aggregate)
match_aggregate$prediction_0down10d <- prediction_dataset$Predicted
prediction_dataset <- read.csv("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/Predictions/realtime_data_predictions_working_model_V3_primary0down15d_output.tsv",sep="\t")
rownames(prediction_dataset) <- rownames(match_aggregate)
match_aggregate$prediction_0down15d <- prediction_dataset$Predicted
prediction_dataset <- read.csv("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/Predictions/realtime_data_predictions_working_model_V3_primary0down20d_output.tsv",sep="\t")
rownames(prediction_dataset) <- rownames(match_aggregate)
match_aggregate$prediction_0down20d <- prediction_dataset$Predicted
prediction_dataset <- read.csv("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/Predictions/realtime_data_predictions_working_model_V3_primary0down25d_output.tsv",sep="\t")
rownames(prediction_dataset) <- rownames(match_aggregate)
match_aggregate$prediction_0down25d <- prediction_dataset$Predicted
prediction_dataset <- read.csv("E:/Market_Data/DiscountOptionData/DTNSubscription/revised_derived_aggregates/Freeze20240404/Predictions/realtime_data_predictions_working_model_V3_primary0down50d_output.tsv",sep="\t")
rownames(prediction_dataset) <- rownames(match_aggregate)
match_aggregate$prediction_0down50d <- prediction_dataset$Predicted
...
for(temp_date_i in 1:length(temp_date_list)){
  ...
  if(temp_date %in% match_aggregate$EOD_option_quote_date){
    ...
    temp_output <- temp_pred[,c("prediction_2up5d","prediction_4up10d","prediction_6up15d","prediction_8up20d","prediction_10up25d","prediction_20up50d",
                           "prediction_0down5d","prediction_0down10d","prediction_0down15d","prediction_0down20d","prediction_0down25d","prediction_0down50d",
                           "avgOpenClose","EOD_option_underlying_ticker","EOD_option_quote_date",
                           colnames(temp_pred)[grepl("relative_avgOpenClose_ahead",colnames(temp_pred))],colnames(temp_mbData))]
