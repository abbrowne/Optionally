...
test_files <- list.files(paste0(main_dir,"Derived_Aggregates/"))
...
if(length(test_files) > 0){
  ...
  full_aggregate <- readRDS(paste0(main_dir,"Derived_Aggregates/",
...
temp_data <- read.csv("E:/Market_Data/nasdaq_screener_04032024.csv")
...
SP500_tickers <- SP500_tickers[SP500_tickers %in% test$Symbol]
...
temp_data[temp_data$Sector %in% c("","Miscellaneous"),]
saveRDS(temp_data,"E:/Market_Data/SP500_sectors_03042024.RDS")
